...
#initialise a file to write runtime-diagnostics
labels = ['Ts','PE','KE'+str(species[0].name),'px+','py+','pz+','KE'+str(species[1].name),'px-','py-','pz-','TE'] 
output_diag_init(labels)
...
while(world.advanceTime()):
    ...
    #runtime-diagnostics   
    if (world.ts==1)or(world.ts%200==0):        
